...
-- Use Treesitter folds, but keep everything expanded until you toggle manually (za/zc/zo).
      ...
      config = function()
        ...
        vim.api.nvim_create_autocmd('LspAttach', {
          ...
          callback = function(event)
            ...
            -- Show symbol docs/type info in a floating window.
        ...
        -- Snippet Engine
        {
          ...
          dependencies = {
            ...
            --    https://github.com/rafamadriz/friendly-snippets
            {
              ...
              config = function()
                -- NOTE: 如果要添加snippets 那么必须在package .json里先添加语言支持
